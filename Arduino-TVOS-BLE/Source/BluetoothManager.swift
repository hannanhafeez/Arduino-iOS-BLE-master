...
public class BluetoothManager : NSObject, CBCentralManagerDelegate, CBPeripheralDelegate {
	private let normalServiceUUID: String = "37fc19ab-98ca-4543-a68b-d183da78acdc"
	private let normalCharacteristicUUID: String = "a40d0c2e-73ba-4d8b-8eef-9a0666992e56"
	
	private let hm10ServiceUUID: String = "FFE0"
	private let hm10CharacteristicUUID: String = "FFE1"
	
	func getNormalServiceId() -> String{ normalServiceUUID }
	func getNormalCharacteristicId() -> String{ normalCharacteristicUUID }
	
	func getHm10ServiceId() -> String{ hm10ServiceUUID }
	func getHm10CharacteristicId() -> String{ hm10CharacteristicUUID }
